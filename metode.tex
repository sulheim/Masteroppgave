...
The Sonazoid\texttrademark microbubbles are used together with microdroplets to form the ACT\texttrademark clusters, and by itself as contrast agent. The microbubbles are shipped freeze-dried, and reconstituted with sterile water to create a solution with a gas volume content of about 1\%. %Anyhting more here?

\subsubsection{Imaging setup}
%16Mhz
All ultrasound images used in this research has been imaged with the Vevo\texttrademark 2100 imaging system from Visual Sonics.
